...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background px-2 py-2 sm:px-4 sm:py-3">
      {showSearch ? (
        <div className="flex w-full items-center gap-2">
          ...
          <div className="relative flex-1">
            ...
            />
            <Button
              className="absolute right-0 top-0 h-full rounded-l-none rounded-r-full px-3"
              variant="ghost"
            >
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-4">
            {/* Menu button removed from header as it's now in the Home component */}
            <div className="flex items-center gap-1">
              <svg viewBox="0 0 90 20" className="h-5 w-16 sm:h-6 sm:w-20">
          ...
          <div className="hidden md:flex md:w-full md:max-w-md md:items-center md:px-4">
            <div className="relative w-full">
              <Input
                className="w-full rounded-l-full border-r-0 pr-10"
                placeholder="Search"
                type="search"
              />
              <Button
                className="absolute right-0 top-0 h-full rounded-l-none rounded-r-full px-4"
                variant="secondary"
              >
                <Search className="h-4 w-4" />
              </Button>
